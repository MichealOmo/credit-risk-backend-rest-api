...
# @router.post("/auth/reset-password")
# # async def reset_password(reset_password_token: str, request: schema.ResetPassword):
# async def reset_password(request: schema.ResetPassword):
...
#     # Reset new password
#     # code_object = schema.EmailRequest(**reset_token)
#     code_object = schema.EmailRequest(reset_token)
...
#     # Disable reset code
#     await crud.disable_reset_code(request.password_token, code_object.email)
